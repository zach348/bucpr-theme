...
<div class="tribe-events-calendar-list__event-date-tag tribe-common-g-col">
	<time class="tribe-events-calendar-list__event-date-tag-datetime d-flex" datetime="<?php echo esc_attr( $event_date_attr ); ?>">
		<span class="h4 float-left w-auto color-secondary tribe-events-calendar-list__event-date-tag-weekday">
			<?php echo esc_html( $event_week_day ); ?>
		</span>
		<span class="h4 float-left w-auto color-secondary tribe-events-calendar-list__event-date-tag-daynum tribe-common-h5 tribe-common-h4--min-medium">
