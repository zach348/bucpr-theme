...
?>
<div class="tribe-events-calendar-list__event-datetime-wrapper tribe-common-b2 mb-0">
	...
	<?php endif; ?>
	<time class="h4 color-primary primary-color mb-0 tribe-events-calendar-list__event-datetime" datetime="<?php echo esc_attr( $event_date_attr ); ?>">
