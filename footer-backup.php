...
<div id="mc_embed_signup">
    <form action="https://cpr.us3.list-manage.com/subscribe/post?u=8fd74629f76ce6ba754fd18ad&amp;id=ae8b3d5004&amp;f_id=000342e2f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_self">
        <div id="mc_embed_signup_scroll">
        <h2>Enter your information below</h2>
        <div class="indicates-required"><span class="asterisk">*</span> indicates required</div>
<div class="mc-field-group">
        <label for="mce-ROLE">Your Role*  <span class="asterisk">*</span>
</label>
        ...
        <span id="mce-ROLE-HELPERTEXT" class="helper_text"></span>
</div>
<div class="mc-field-group">
        <label for="mce-EMAIL">Email Address*  <span class="asterisk">*</span></label>
        <input type="email" value="" name="EMAIL" class="required email" id="mce-EMAIL" required>
        <span id="mce-EMAIL-HELPERTEXT" class="helper_text"></span>
        <input type="hidden" name="REFERREDBY" class=" text" id="mce-REFERREDBY" value=<?php echo $current_url ?>>
</div>
<div id="mergeRow-gdpr" class="mergeRow gdpr-mergeRow content__gdprBlock mc-field-group">
    <div class="content__gdpr">
        <fieldset class="mc_fieldset gdprRequired mc-field-group" name="interestgroup_field">
		<label class="checkbox subfield required" for="gdpr_34149"><input type="checkbox" id="gdpr_34149" name="gdpr[34149]" value="Y"><span id="agree-privacy-checkbox-text"> I have read and agree to BU-CPR's <a target="_blank" href="https://cpr.bu.edu/privacy-policy" class="link">Privacy Policy</a>
		</span> </label>
    ...
    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_8fd74629f76ce6ba754fd18ad_ae8b3d5004" tabindex="-1" value=""></div>
