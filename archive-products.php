<?php get_header(); ?>
	...
	<div id="primary" class="content-area">
      ...
      <?php get_template_part( 'template-parts/heros/hero', 'products' ); ?>

			<?php if (get_field('products_featured_posts_toggle', 'option')) : ?>
				<?php //$products_featured_posts = get_field('products_featured_posts','option'); ?>
				<?php //if ($products_featured_posts): ?>
					<div class="featured">
						<div class="container my-5 py-4 px-0">
							<div class="inner row d-flex flex-wrap m-0">
								...
								<?php if (have_rows('products_featured_posts_selection','option')) : ?>
									<?php while(have_rows('products_featured_posts_selection','option')) : the_row(); ?>
										<?php $post = get_sub_field('products_featured_post');
											if ($post) : setup_postdata($post); ?>
											<div class="col-sm row pl-0 mx-0 mb-4 mb-lg-0">
												...
												<div class="content col-lg px-0 pr-lg-3 mt-2 mt-lg-0">
													...
													<div class="mb-3">
														...
														<?php if (count($product_and_resource_topics) > 0) { ?>
															<?php echo '<p class="topics secondary-color mb-3">'; ?>
			...
			<div class="filters background-primary-color py-5">
				<div class="container my-3 my-lg-0">
					<div class="titles">
						...
						<h2 class="h1 color-white">Explore Products</h2>
						<p class="color-white">You may select more than one</p>
					</div>
					<div class="row facets">
						<div class="col-md-4 products-type">
      ...
      <?php endif; ?>
			...
			<?php get_template_part( 'template-parts/content', 'product-archive-page' ); ?>
